  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center">
        <img src="assets/img/102.jpg" alt="" width="200px">
  ...
  while ($row = mysqli_fetch_array($result)){
    ?>
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2"><?php echo $row['full_name'] ?></span>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Add Items</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="add-dishes.php">
              <i class="bi bi-circle"></i><span>Add Dishes</span>
            </a>
          </li>
          <li>
            <a href="add-menu.php">
          ...
          <li>
            <a href="add-restaurants.php">
              <i class="bi bi-circle"></i><span>Add Restaurants</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
